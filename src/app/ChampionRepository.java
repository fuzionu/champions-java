...
public class ChampionRepository
{
    ...
    private static Set<Champion> getAllChampions()
    {
        ...
        championsSet.add(new Champion("Gnar", FIGHTER, 3631, 57, "Rage", 12, 50, "Melee / Ranged", 433, 1.44, 385, 233, 199, 427));
        championsSet.add(new Champion("Rengar", ASSASSIN, 2999, 43, "Ferocity", 1, 0, "Melee", 601, 1.15, 350, 150, 122, 500));
        championsSet.add(new Champion("Kled", FIGHTER, 3136, 50, "Courage", 5, 35, "Meele", 333, 1.85, 325, 100, 100, 450));
